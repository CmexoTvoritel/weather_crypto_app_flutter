...
class CryptoApi {
  ...
  get url => "https://api.coingecko.com/api/v3/";
  get endPoint => "coins/markets?vs_currency=usd&order=market_cap_desc&per_page=10&page=1&sparkline=false&price_change_percentage=1h";

  Future<ResponseCryptoModel> fetchData() async {
    var httpUrl = Uri.https(url, endPoint);
